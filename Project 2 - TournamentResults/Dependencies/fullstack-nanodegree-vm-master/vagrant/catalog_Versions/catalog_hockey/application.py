...
def categoryCheck(category_name):
    ...
    """
    print "def categoryCheck(category_name) called."
...
def deleteEmptyCategory(category_id):
    ...
    """
    print "def deleteEmptyCategory(category_id): called."
...
def showCategory(category_name):
    ...
    """
    print "def showCategory(category_name): called"
...
def showItem(category_name, item_id):
    ...
    """
    print "def showItem(category_name, item_id): called"
...
def editItem(item_id):
    ...
    """
    print "def editItem(item_id): called"
...
def deleteItem(item_id):
    ...
    """
    print "def deleteItem(item_id): called"
...
def uploaded_file(filename):
    ...
    """
    print "def uploaded_file(filename): called"

...
from setup_database_schema import Category, Base, Item, User
...
Kirk = User(name="Kirk Poole")
session.add(Kirk)

John = User(name="Johnny Walker")
session.add(John)
...
Obi = Item(name="Obi",category=Judo,owner=Kirk,image="http://3.bp.blogspot.com/-Rkxk5i9mMd4/Ul_rFJ1KwoI/AAAAAAAAAbU/6lw0hQSqZGg/s1600/Black%2BBelt.png")
session.add(Obi)
